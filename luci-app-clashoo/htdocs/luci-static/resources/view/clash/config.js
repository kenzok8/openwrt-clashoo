...
var callListSubs      = rpc.declare({ object: 'luci.clash', method: 'list_subscriptions',  expect: {} });
var callListDir       = rpc.declare({ object: 'luci.clash', method: 'list_dir_files',      params: ['type'], expect: {} });
var callDownloadSubs  = rpc.declare({ object: 'luci.clash', method: 'download_subs',       expect: {} });
var callUpdateSub     = rpc.declare({ object: 'luci.clash', method: 'update_sub',          params: ['name'], expect: {} });
var callSetConfig     = rpc.declare({ object: 'luci.clash', method: 'set_config',          params: ['name'], expect: {} });
var callDeleteCfg     = rpc.declare({ object: 'luci.clash', method: 'delete_config',       params: ['name', 'type'], expect: {} });
var callUploadConfig  = rpc.declare({ object: 'luci.clash', method: 'upload_config',       params: ['name', 'content', 'type'], expect: {} });
var callApplyRewrite  = rpc.declare({ object: 'luci.clash', method: 'apply_rewrite',       params: ['base_type','base_name','rewrite_type','rewrite_name','output_name','set_active'], expect: {} });
var callFetchUrl      = rpc.declare({ object: 'luci.clash', method: 'fetch_rewrite_url',   params: ['url','name'], expect: {} });
...
return view.extend({
  ...
  _buildSubsPanel: function (subsData, subFiles, upFiles, tplFiles) {
    ...
    var dlBtn = E('button', {
      ...
      click: function () {
        uci.set('clash', 'config', 'subscribe_url', urlInput.value);
  ...
  _buildProxyForm: function (container) {
    ...
    sa.anonymous = false; sa.addremove = true;
  ...
  _buildDnsForm: function (container) {
    ...
    s = m.section(form.NamedSection, 'config', 'clash', '基础 DNS');
    s.addremove = false;
